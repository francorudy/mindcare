...
function IconSparkles() {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className="h-5 w-5">
      ...
      />
      <path
        d="M19 11l.7 2.1L22 14l-2.3.9L19 17l-.7-2.1L16 14l2.3-.9L19 11Z"
        fill="currentColor"
        opacity="0.45"
      />
    </svg>
...
function IconUsers() {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className="h-5 w-5">
      <path
        d="M16 20v-1.2c0-2-1.8-3.6-4-3.6s-4 1.6-4 3.6V20"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      ...
      />
      <path
        d="M19.5 20v-1c0-1.6-1.2-2.9-2.8-3.3"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        opacity="0.65"
      />
      <path
        d="M16.7 6.4a2.7 2.7 0 0 1 0 5.2"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        opacity="0.65"
